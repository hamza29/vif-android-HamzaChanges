...
public class SharedActivity extends AppCompatActivity {
    ...
    private void CallingApi() {
        if (GlobalClass.getInstance().isOnline(SharedActivity.this)) {
            filesModelsList.clear();
            WebReq.get(SharedActivity.this, getIntent().getExtras().getString("api"), null,
        ...
        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
            ...
            try {
                if (response.getString("status").equals("true")) {
                    ...
                    recyclerView.setLayoutManager(new GridLayoutManager(SharedActivity.this, 2));
                    filesRecyclerViewAdapter = new FilesRecyclerViewAdapter(SharedActivity.this,
