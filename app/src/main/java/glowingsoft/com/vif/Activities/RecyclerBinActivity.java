...
public class RecyclerBinActivity extends AppCompatActivity {
    ...
    MainActivityFooterAdapter mainActivityFooterAdapter;
...
SharedPreferences sharedPreferences;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerBinActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    private void CallingApi() {
        if (GlobalClass.getInstance().isOnline(RecyclerBinActivity.this)) {
            WebReq.get(RecyclerBinActivity.this, getIntent().getExtras().getString("api"),
        ...
        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
            ...
            try {
                ...
                if (response.getString("status").equals("true")) {
                    ...
                    mainActivityFooterAdapter = new MainActivityFooterAdapter(RecyclerBinActivity.this, jsonArrayFiles, jsonArrayFolders, null, null, shimmerFrameLayout, recyclerView);
